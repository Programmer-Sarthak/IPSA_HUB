...
CREATE TABLE `likes` (
  ...
  CONSTRAINT `likeUserId` FOREIGN KEY (`userid`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `likes` VALUES (8,29,9),(9,29,24),(12,29,2),(20,57,3);
